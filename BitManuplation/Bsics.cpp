...
void print(lli num)
{
    // Printing the binary representation of the number
    for (int i = 10; i >= 0; i--){
 ...
 // Checking if the ith bit is set or not
    ...
    // check if any number is power of 2
    ...
    // Upper case 5th bit = 0
    // lower case 5th bit = 1
    // space = 00100000
    //underscore = 01011111
    ...
    // You can find a letter's position in the alphabet by taking its bitwise AND with 31 (00011111 in binary).}

    // swaping a number using xor operation
    int a = 5;
    int b = 4;
